    ...
    public class DigitalOut
    {
        ...
        public int Data
        {
            ...
            { 
                if (data != value)
                {
                    ...
                    OnDigitalOutputChanged(EventArgs.Empty);    //Mit dieser Methode wird der Event, dass sich etwas
                                                                //am Outputport geändert hat, erzeugt
                }
            }
        }
        #endregion
        ...
        public virtual bool this[int bit]
        {
            ...
            set
            {
                if (value)
                {
                    // gewünschtes Bit setzen, indem das Data Property bitweise ODER-verknüpft wird
                    Data = Data | (1 << bit);
                }
                else
                {
                    // gewünschtes Bit löschen, indem das Data Property bitweise UND-verknüpft wird
                    Data = Data & ~(1 << bit);
                }
            }
        }
